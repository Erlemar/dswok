...
[Lee & Seung, 1999](https://www.nature.com/articles/44565). Factorizes a document-term matrix $V$ into two non-negative matrices:
...
[Dieng, Ruiz, Blei, 2020](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00325/96463). Combines topic modeling with [[Word Embeddings|word embeddings]]. Each word and each topic live in the same embedding space; the probability of word $w$ under topic $k$ is:
...
This flexibility allows simultaneous optimization for topic sparsity, inter-topic distinctness, and incorporation of side information. Most of what made it attractive (decorrelated, sparse, hierarchical topics) can now be achieved with BERTopic's modular pipeline.
