...
Showed the best overall correlation with human judgment in classical topic model evaluations. Typical "good" values land in the 0.05–0.25 range across the studies surveyed. [Hoyle et al. (2021)](https://arxiv.org/abs/2107.02173) showed that automated coherence metrics correlate poorly with human judgment for neural topic models; treat them as a rough sanity check, not a leaderboard.
