...
A: Change the output activation function from softmax to sigmoid and the [[General losses|loss function]] from categorical cross-entropy to binary cross-entropy.
